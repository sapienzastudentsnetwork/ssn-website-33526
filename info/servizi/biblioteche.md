...
Tutte le biblioteche offrono un certo numeri di posti a sedere per poter leggere e studiare: è possibile trovare una mappa [qui](https://opac.uniroma1.it/SebinaOpacRMS/article/biblioteche-sapienza/biblioteche). Ogni studente Sapienza ha accesso a **tutte le biblioteche in tutte le sedi dell'università**. L'accesso potrebbe richiedere soltanto di **identificarsi**.

Non esiste, invece, un elenco preciso delle aule studio, ma anche esse si trovano in quasi ogni edificio dell'università.
...
![screenshot di un esempio di ricerca](https://i.imgur.com/vXip7re.png)
...
![screenshot della pagigna del libro](https://i.imgur.com/FWZb6K6.png)
